...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cv_education', 'end_date', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Education.start_date'
        db.alter_column(u'cv_education', 'start_date', self.gf('django.db.models.fields.IntegerField')())
