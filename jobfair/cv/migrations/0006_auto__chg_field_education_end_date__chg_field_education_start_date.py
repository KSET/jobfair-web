...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cv_education', 'end_date', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Education.start_date'
        db.alter_column(u'cv_education', 'start_date', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Education.end_date'
        db.alter_column(u'cv_education', 'end_date', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Education.start_date'
        db.alter_column(u'cv_education', 'start_date', self.gf('django.db.models.fields.CharField')(max_length=4))
    ...
    models = {
        ...
        u'cv.education': {
            ...
            'end_date': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            ...
            'start_date': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
